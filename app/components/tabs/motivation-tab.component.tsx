import { HighlightText, Keyword } from '../typeography.component';
        ...
        <div className="p-6">
            <section className="animate-fadeIn">
                ...
                <ul className="list-disc text-gray-600 ml-6">
                    <li>The marker tool does <HighlightText text="not" /> perform well as a <HighlightText text="highlighter" /></li>
                </ul>
                <hr className="my-4" />
                <p className="text-gray-600 mb-4">
                ...
                <p className="text-gray-600 mb-4">
                    ...
                    I have only used <Keyword text="canvas" /> a few times, so that was a bit of a challenge.
